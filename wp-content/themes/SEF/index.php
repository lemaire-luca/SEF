...
<main role="main">
    ...
    <section id="help" class="help">
        ...
        <div class="help__right">
            <h2 role="heading" aria-level="2">Les différentes formes d'aide offertes par le <abbr title="Service d'entraide familiale">SEF</abbr></h2>
            <p>
                Le Service d'Assistance Familiale de Huy (<abbr title="Service d'entraide familiale">SEF</abbr>) offre une variété d'aides
    ...
    <section id="information" class="information">
        ...
        <p>
            Le Service d'Entraide Familiale (<abbr title="Service d'entraide familiale">SEF</abbr>) de Huy a été fondé il y a
