...
<?php if (have_posts()): while (have_posts()): the_post(); ?>
    ...
    <section id="services" class="services">
        <div class="services__infos">
            ...
            <p>L’objectif de l’<abbr title=" association sans but lucratif">asbl</abbr> :
                ...
                Le temps passé au <abbr title="Service d'entraide familiale">SEF</abbr> doit être mis à profit par
                chacun pour règler
    ...
    <section id="mission" class="mission">
        <div class="mission__left">
            ...
            <p>
                Le <abbr title="Service d'entraide familiale">SEF</abbr> a pour mission de fournir un soutien essentiel
                aux personnes en situation précaire. Nous nous
                engageons à offrir des solutions de logement sûres et abordables, tout en favorisant l'inclusion sociale
                et
